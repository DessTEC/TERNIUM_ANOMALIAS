  ...
  return (
    <div className="pb-4">
      ...
      <div class="flex relative w-full">
        <select className="appearance-none w-full bg-white border border-gray-800 text-md text-gray-500 px-2.5 py-2 pr-8 rounded-md leading-tight focus:outline-none focus:shadow-outline w-full">
