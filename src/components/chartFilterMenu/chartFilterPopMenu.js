...
export default function ChartFilterPopMenu(props){
    ...
    const options = [
        <>
            ...
            <DropDownMenuOption iconLeft={faCalendarDays} subMenu={<CalendarFilterDropdown initDate={initDate} endDate={endDate} setInitDate={setInitDate} setEndDate={setEndDate} inputValueStart = {inputValueStart} setInputValueStart = {setInputValueStart} inputValueEnd = {inputValueEnd} setInputValueEnd = {setInputValueEnd}/>} textDisplay="Fecha" expandable={true}/>
