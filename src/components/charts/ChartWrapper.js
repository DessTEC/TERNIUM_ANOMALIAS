...
export const ChartWrapper = ({ chartId, chartData, options, type, setSelectCharts, analysisType, atributos, dataModelo, setCharts, charts, minValAnomalias, maxValAnomalias, varX, varY, valY }) => {
        ...
        <div className="w-full p-4 flex flex-row">
            ...
            <div className="w-8">
                <div className="flex flex-column justify-content-start">
                    <ChartFilterPopMenu atributos={atributos} analysisType={analysisType} chartType={type} dataModelo={dataModelo} setCharts = {setCharts} id={chartId} charts={charts} minValAnomalias={minValAnomalias} maxValAnomalias={maxValAnomalias} varX={varX} varY={varY} valY={valY}/>
