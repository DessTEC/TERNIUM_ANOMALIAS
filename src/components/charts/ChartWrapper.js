...
export const ChartWrapper = ({ chartId, chartData, options, type, setSelectCharts, analysisType, atributos, dataModelo }) => {
        ...
        <div className="w-full p-4 flex flex-row">
            ...
            <div className="w-8">
                <div className="flex flex-column justify-content-start">
                    <ChartFilterPopMenu atributos={atributos} analysisType={analysisType} chartType={type} dataModelo={dataModelo}/>
