        ...
        <div className="w-full p-4 flex flex-row">
            ...
            <div className="w-8">
                <div className="flex flex-column justify-content-start">
                    <button className="w-full mb-2 rounded-t-md rounded-b-md border border-gray-200 shadow-md bg-[#F5F5F5]"><FontAwesomeIcon icon={faEllipsisVertical} className="color-black" /></button>
                    <button className="w-full mb-2 rounded-t-md rounded-b-md border border-gray-200 shadow-md bg-[#F5F5F5]"><FontAwesomeIcon icon={faMagnifyingGlass} className="color-black w-4/6" onClick={handleZoom}/></button>
                </div>
            </div>
