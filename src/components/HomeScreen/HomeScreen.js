        ...
        <div className='w-full'>
            ...
            <div className='max-w-[1240px] mx-auto text-white relative mb-10'>
                <div className='grid grid-cols-1 lg:grid-cols-2 relative gap-y-16 px-4 pt-40 justify-items-center'>
                    <Link to={'/dashboard/subir'} className='bg-[#F25C29] rounded-t-xl rounded-b-xl shadow-2xl pb-2 w-5/6'>
                    ...
                    <Link to={'/dashboard/consultar'} className='bg-[#FAAD42] rounded-t-xl rounded-b-xl shadow-2xl pb-2 w-5/6'>
                        <div className='p-8 w-full'>
